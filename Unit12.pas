...
var x,y : integer;
begin
//when searching for an item which
...
begin
//when the relevant tabs are pressed, the relevant
//forms are shown.
...
var x : integer;
begin
//       when the form is shown again, either after transaction or after the cashier
//revisist this form again, we refresh the stock so we can be sure
//of how much we have remaining.
BitBtn1Click(self);
