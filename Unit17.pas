...
uses
  ...
  Dialogs, jpeg, pngimage, ExtCtrls,unit6,unit8,unit20,unit11, unit1, unit26,unit21, payments, UserAcc,
  StdCtrls;
...
unit26.Form26.Account := Self.Account;
end;
