...
uses dbConn_u , Variants, SYsUtils, Messages, Dialogs;
...
//this method is used to create an employee account
...
with dbConn_u.DataModule1 do
  begin
    ...
    //here we are checking to see if there are other employees with matching details
...
//this function is used to create a vendor
//and returns the new vendor id
...
//this is used to load up user name of last loggedin user
    ...
    with dbConn_u.DataModule1.qryMaintenance do
      ...
      if RecordCount=1 then
        begin
          ...
          Post;
          ShowMessage('Necessary updates have been made. Program will proceed normally.');
        end;
       Close;
      end;
  end
...
with dbConn_u.DataModule1 do
  ...
  begin
    ...
    //in the event of there being an error, we call the rollback function
...
with dbConn_u.DataModule1 do
    begin
      ...
      dbProvider.CommitTrans;
        ...
        begin
          Result := 'THERE WAS AN ERROR, CONTACT IT DEPARTMENT';
...
//this function is used to write content passed through parameter to textfile .
