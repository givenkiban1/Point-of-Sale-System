  ...
  begin
    ...
    if Panel2.Caption = 'CREATE STOCK' then
      begin
        ...
        //we now begin creating the stock
        ADOTable1.Insert;
        ...
        ADOTable1['ImageFile'] := StringReplace(productName, ' ', '', [rfReplaceAll]) + ExtractFileName(picName);
...
begin
//TO RESET ALL THE VALUES AND INITIALIZE SOME
...
begin
//
//WHEN USER CHOSES A CERTAIN SUPPLIER ID, WE DISPLAY CORRESPONDING COMPANY NAME
